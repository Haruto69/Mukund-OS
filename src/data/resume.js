/**
 * Resume content — extracted verbatim from `public/Mukund_V_Resume.pdf`.
 *
 * SOURCE OF TRUTH: the PDF, and nothing else. This file was transcribed from
 * `pdftotext -layout -enc UTF-8` output, with the hyperlinks recovered from the
 * PDF's own `/URI` link annotations (matched to their on-page rectangles, so
 * each project link is the one the PDF actually attaches to that title).
 *
 * Rules for anyone editing this file:
 *   - Do NOT merge in data from `projects.js`, `profile.js`, `experience.js`
 *     or any section of the site. Those may be newer or worded differently;
 *     this section renders the PDF as it stands.
 *   - Do NOT rewrite, shorten, expand or "improve" the bullet wording.
 *   - Section order below matches the PDF's order exactly:
 *     Summary → Technical Skills → Projects → Experience → Education →
 *     Achievements.
 *   - If the PDF is replaced, re-extract and update this file; the PDF is
 *     never regenerated from this file.
 */
...
export const resumeIdentity = {
  ...
  contacts: [
    { label: "+91 84310 41791", href: "tel:+918431041791", kind: "phone" },
    {
...
export const resumeSkills = [
  { label: "Programming", items: "C, Java" },
  { label: "Frameworks & Libraries", items: "Flask, React.js" },
  {
  ...
  },
  {
    label: "AI & Security",
    items:
      "Generative AI APIs, Trivy, Kubescape, kube-score, SBOM, DevSecOps",
  },
];
