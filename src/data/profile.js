export const profile = {
  ...
  securityFoundation: {
    ...
    skills: ["vulnerability scanning", "Kubernetes security", "RAG/security assistant", "Docker/security basics", "security-aware development mindset"]
  },

  buildingMindset: [
    "Prefers practical projects over tutorial-only work",
    "Values debugging production issues",
    "Wants projects to be deployed and interview-explainable",
    "Uses iterations/releases",
    "Learning through building"
  ],

  workingStyle: [
    "Practical learner",
    "Prefers building and debugging",
    "Likes structured roadmaps",
    "Values clean UI and clear explanations",
    "Currently improving consistency and frontend depth"
  ]
};
